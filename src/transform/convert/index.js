 ...
 * @param {Object} mockMoment if needed to mock moment (for automated tests)
 * @return Newly generated MarcRecord object
 */
export default ({harvestSource, fieldValueInterface, commonErrorPayload, mockMoment = false}) => {
  const momentSource = mockMoment || moment;
